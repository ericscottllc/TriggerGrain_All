...
import { PricingLineChart } from './PricingLineChart';
import type { CropClassChartData } from '../utils/chartDataTransform';

interface CropClassChartPanelProps {
  chartData: CropClassChartData;
  defaultExpanded?: boolean;
}

export const CropClassChartPanel: React.FC<CropClassChartPanelProps> = ({
  chartData,
