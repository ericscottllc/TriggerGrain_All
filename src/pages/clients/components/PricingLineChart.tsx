...
import type { ChartDataPoint, SeriesConfig } from '../utils/chartDataTransform';
import { formatCurrency, formatDate } from '../utils/chartDataTransform';

interface PricingLineChartProps {
  data: ChartDataPoint[];
  series: SeriesConfig[];
  title: string;
  height?: number;
...
export const PricingLineChart: React.FC<PricingLineChartProps> = ({
  data,
  series,
  title,
  height = 400,
